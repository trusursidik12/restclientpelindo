          ...
          <div class="col-sm-6">
            ...
            <table border="0" width="100%" style="margin-left: 22px; margin-top: -10px; font-size: 18px;">
              <tr>
                ...
                <td width="29" class="btn-secondary"><?= $pelindodata01[0]['pm10'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata01[0]['pm25'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata01[0]['tsp'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= round($pelindodata01[0]['so2'] / 10) ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata01[0]['co'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata01[0]['o3'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata01[0]['no2'] ?></td>
                <td width="15"></td>
              </tr>
            </table><br>
          </div>
      ...
      <div class="col-sm-12 text-center">
        ...
        <div class="row bg-white">
          ...
          <div class="col-sm-6">
            ...
            <table border="0" width="100%" style="margin-left: 22px; margin-top: -10px; font-size: 18px;">
              <tr>
                <td width="29" class="btn-secondary"><?= $pelindodata02[0]['pm10'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata02[0]['pm25'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata02[0]['tsp'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= round($pelindodata02[0]['so2'] / 10) ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata02[0]['co'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata02[0]['o3'] ?></td>
                <td width="1"></td>
                <td width="29" class="btn-secondary"><?= $pelindodata02[0]['no2'] ?></td>
                <td width="15"></td>
              </tr>
            </table><br>
          </div>
